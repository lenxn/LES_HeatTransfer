...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{initial_geometry_1.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{initial_mesh_3.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{3d_mesh_2.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{wall_cell.png}
